...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@tutors/hooks/mode": resolve(__dirname, "packages/svelte/utils/hooks/src/mode.ts"),
      "@tutors/hooks/server": resolve(__dirname, "packages/svelte/utils/hooks/src/server.ts"),
      "@tutors/hooks/client": resolve(__dirname, "packages/svelte/utils/hooks/src/client.ts"),
      "@tutors/hooks": resolve(__dirname, "packages/svelte/utils/hooks/src/index.ts"),
      "@tutors/community/utils/error-transport": resolve(__dirname, "packages/svelte/community/src/utils/error-transport.ts"),
