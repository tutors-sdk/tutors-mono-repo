...
describeFeature(feature, ({ Background, Scenario, ScenarioOutline }) => {
  ...
  Scenario("Successfully load a course", ({ When, Then, And }) => {
  ...
  Scenario("Load a course with nested units", ({ Given, When, Then, And }) => {
  ...
  ScenarioOutline("Load different learning object types", ({ Given, When, Then, And }, variables) => {
