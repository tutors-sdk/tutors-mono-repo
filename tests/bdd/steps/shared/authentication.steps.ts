...
describeFeature(feature, ({ Background, Scenario }) => {
  ...
  Scenario("Sign in with GitHub OAuth", ({ Given, When, Then, And }) => {
  ...
  Scenario("Anonymous browsing", ({ Given, When, Then, But }) => {
    Given("I am not authenticated", notAuthenticated);
  ...
  Scenario("Track authenticated user activity", ({ Given, When, Then, And }) => {
