...
import { getLocksForCourse } from "../../../packages/svelte/rbac/src/lock-store.ts";
import { isLoRouteLocked, rbacService } from "../../../packages/svelte/rbac/src/rbac-service.svelte.ts";
